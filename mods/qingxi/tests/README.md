...
版本：v3 ｜ 世界v2完整路径见[世界测试设计](../docs/world-mvp-testing.md)，成长、战斗与社交见[v3测试设计](../docs/v3-testing.md)，实际执行见验证记录。下列D-*继续验证原数值及事务语义，夹具须设置对应行动房间；真实移动额外产生事件，不能用旧五步版本计数衡量世界完整流程。
