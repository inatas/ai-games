...
严格JSON内容、有限规则引用、启动校验和初始化幂等；青溪地图/NPC配置化，mods/minimal提供可运行样板。首版无YAML解析器、Lua和通用规则语言。
...
- [x] 对应[验收契约](../../docs/testing/configured-game-runtime.md)的MP-01～05行为实现与自动化回归，证据及覆盖限制见验证记录。
