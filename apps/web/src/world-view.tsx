...
import type { projectMap } from '../../../examples/wuxia-mud/src/world.ts';
import type { makeScene, GameAction } from '../../../examples/wuxia-mud/src/scene.ts';
  ...
  return <>
    ...
    <div className="world-panels" data-tab={tab}>
      <section className="map-panel" aria-label="房间关系图">
        <div className="panel-heading"><span>青溪行路图</span><small>已知近邻 · 两步范围</small></div>
